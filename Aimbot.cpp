...
public:
    ...
    void update()
    {
        ...
        // Check if the local player is in crosshair
        if (m_localPlayer->isCrosshair())
         {
            // Perform the mouse click action
            m_x11Utils->keyPress(0x0000);    //* Delete mouseClick(1) 0xff55
            usleep(500); // Sleep for 500 milliseconds (500,000 microseconds)
         } 
    ...
    Player *findClosestEnemy()
    {
        ...
        for (int i = 0; i < m_players->size(); i++)
        {
            ...
            // Здесь вы можете использовать desiredViewAngleYaw и desiredViewAnglePitch
